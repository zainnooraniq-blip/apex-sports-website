...
const APEX = {
  ...
  team: [
    ...
    { name: "Imran Ahmad Khan", title: "Chief Executive Officer", photo: "Imran.png", bio: "A dynamic sports management professional with more than a decade of experience across commercial, brand, league management, broadcast, production, and talent management.<br><br>Imran was previously heading a sports TV network where he led content acquisition, development, commercial growth strategy, and relationship management. His portfolio has included rights for the FIFA World Cup, Formula 1, La Liga, multiple ICC events, international T20 leagues, and bilateral cricket.<br><br>Under his leadership, Apex Sports Consulting has worked on multiple international projects and transactions, including partnerships with the International Cricket Council, SA20, Guyana Global Super League, Formula E, and PUBG Mobile." },
    ...
    { name: "Ozair Ahmad", title: "Director of Esports", photo: "Ozair-Ahmad.png", bio: "Esports entrepreneur and ecosystem builder with degrees in business (Iqra University) and law (University of London at SZABIST). Founder of Next Generation Esports (NGES) in 2018, now one of Pakistan's leading esports agencies — delivering tournament execution, IP development, broadcast production, creator activations, and brand integrations for partners including Garena, Tencent, ESL, Red Bull, and PepsiCo. Recently expanded into the UAE via DMCC Dubai, building scalable esports IPs across the region." },
  ],
